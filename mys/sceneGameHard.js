class SceneGameHard extends Phaser.Scene {
    ...
    constructor ()
    {
        ...
        this.objectsPositions = [new Position(300,150),new Position(300,0),new Position(300,-150),new Position(-300,150),new Position(-300,0),new Position(-300,-150),new Position(0,150),new Position(150,150),new Position(0,0),new Position(-150,150),new Position(150,0),new Position(-150,0),new Position(150,-150),new Position(0,-150),new Position(-150,-150)];
        this.boardObjects = [
            ...
            {sprite:'tomato', id:10, memory:false},
            {sprite:'frog', id:11, memory:false},
            {sprite:'monkey', id:12, memory:false},
            {sprite:'football', id:13, memory:false},
            {sprite:'clock', id:14, memory:false},
            {sprite:'book', id:15, memory:false}
        ]; 
    ...
    preload ()
    {
        ...
        this.load.spritesheet('tomato', 'mys/assets/tomato.png',
        { frameWidth: 150, frameHeight: 100 }  );

        this.load.spritesheet('frog', 'mys/assets/frog.png',
        { frameWidth: 150, frameHeight: 100 }  );
        
        this.load.spritesheet('monkey', 'mys/assets/monkey.png',
        { frameWidth: 150, frameHeight: 100 }  );

        this.load.spritesheet('football', 'mys/assets/football.png',
        { frameWidth: 150, frameHeight: 100 }  );

        this.load.spritesheet('clock', 'mys/assets/clock.png',
        { frameWidth: 150, frameHeight: 100 }  );  

        this.load.spritesheet('book', 'mys/assets/book.png',
        { frameWidth: 150, frameHeight: 100 }  );
    ...
    updateNumCorrects(){
        ...
        if(this.numCorrects == 4){
            ...
            this.victory.play({
              ...
              finishTracking(window.location.href, 'Memory Game Hard', 9,this.numErrors)
        }
    }
