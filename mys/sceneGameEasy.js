class SceneGameEasy extends Phaser.Scene {
    ...
    constructor ()
    {
        ...
        this.objectsPositions = [new Position(150,150),new Position(-150,150),new Position(150,0),new Position(-150,0),new Position(150,-150),new Position(-150,-150)];
        this.boardObjects = [
    ...
    updateNumCorrects(){
        ...
        if(this.numCorrects == 2){
            ...
            this.victory.play({
              ...
              finishTracking(window.location.href, 'Memory Game Easy', 9,this.numErrors)
        }
    }
